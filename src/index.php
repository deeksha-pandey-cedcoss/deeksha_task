                            ...
                            <nav class="navbar navbar-expand-lg bg-info ">
                                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                                    <div class="navbar-nav">
                                        <a class="nav-item nav-link tasks" href="#">All task</a>
                                        <a class="nav-item nav-link completed" href="#">Completed</a>
                                        <a class="nav-item nav-link clear" href="#">Clear completed</a>
                                        <a class="nav-item nav-link incomplete" href="#">Still to do</a>
                                    </div>
                                </div>
                        </div>
                    </div>
